...
namespace CK.DB.Actor.ActorPhoneNumber
{
    ...
    public abstract partial class ActorPhoneNumberTable : SqlTable
    {
        ...
        public abstract Task<int> AddPhoneNumberAsync( ISqlCallContext ctx, int actorId, int userOrGroupId, string phoneNumber, bool isPrimary, bool? validate = null, bool avoidAmbiguousPhoneNumber = true, bool? isPrefixed = null, int? countryCodeId = null );
